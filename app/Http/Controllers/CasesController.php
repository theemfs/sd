...
class CasesController extends Controller
{
	...
	// public function casesAuthorOf(Request $request)
	// {
	...
	// public function casesPerformerOf(Request $request)
	// {
	...
	// public function casesMemberOf(Request $request)
	// {
	...
	// public function casesNew(Request $request)
	// {
	...
	// public function casesOpen(Request $request)
	// {
	...
	// public function casesClosed(Request $request)
	// {
	...
	public function show($id)
	{
		...
		$users_can_be_performers 	= User::whereNotIn('id', $performersIds)->where('is_active', '1')->orderby('name', 'asc')->get();;
