  ...
  <div class="container-fluid">
	...
	<div class="collapse navbar-collapse" id="navbar">
	  <ul class="nav navbar-nav">
			...
			@else
		<li><a href="{{ action('CasesController@index') }}"><i class="fa fa-fw fa-btn fa-briefcase"></i></a></li>
				<li><a href="{{ action('PagesController@adminShow') }}"><i class="fa fa-fw fa-btn fa-cogs"></i></a></li>
