										...
										<tr style="background-color: {{ $case_author->status->color }}">
											...
											<td>
												<a href="{{ action('CasesController@show', $case_author->id) }}">
													...
													<small class="text-muted col-md-11 col-md-offset-1 hidden-xs">{{ mb_substr($case_author->text, 0, 100)."..." }}</small>
												</a>
											</td>
											...
											<td class="text-center">
												@foreach($case_author->performers as $performer)
													<small>
														<a href="{{ action('UsersController@show', $performer->id) }}" data-toggle="tooltip" data-placement="auto" data-container="body" title="{{ $performer->department }}/{{ $performer->title }}: {{ $performer->telephonenumber }}, {{ $performer->mobile }}">
															{{-- <i class="fa fa-fw fa-btn fa-user"></i> --}}
										...
										<tr style="background-color: {{ $case_performer->status->color }}">
											...
											<td>
												<a href="{{ action('CasesController@show', $case_performer->id) }}">
													...
													<small class="text-muted col-md-11 col-md-offset-1 hidden-xs">{{ mb_substr($case_performer->text, 0, 100)."..." }}</small>
												</a>
											</td>
								...
								<table class="table table-condensed table-bordered">
									...
									@foreach ($cases_member as $case_member)
										<tr style="background-color: {{ $case_member->status->color }}">
											...
											<td>
												<small>
													<a href="{{ action('UsersController@show', $case_member->user->id) }}" data-toggle="tooltip" data-placement="auto" data-container="body" title="{{ $case_member->user->department }}/{{ $case_member->user->title }}: {{ $case_member->user->telephonenumber }}, {{ $case_member->user->mobile }}">
														{{-- <i class="fa fa-fw fa-btn fa-user"></i> --}}
										...
										<tr>
											...
											<td>
												<a href="{{ action('CasesController@show', $case_new->id) }}">
													...
													<small class="text-muted col-md-11 col-md-offset-1 hidden-xs">{{ mb_substr($case_new->text, 0, 100)."..." }}</small>
												</a>
											</td>
										...
										<tr style="background-color: {{ $case_open->status->color }}">
											...
											<td>
												<a href="{{ action('CasesController@show', $case_open->id) }}">
													...
													<small class="text-muted col-md-11 col-md-offset-1 hidden-xs">{{ mb_substr($case_open->text, 0, 100)."..." }}</small>
												</a>
											</td>
										...
										<tr style="background-color: {{ $case_closed->status->color }}">
											...
											<td>
												<a href="{{ action('CasesController@show', $case_closed->id) }}">
													...
													<small class="text-muted col-md-11 col-md-offset-1 hidden-xs">{{ mb_substr($case_closed->text, 0, 100)."..." }}</small>
												</a>
											</td>
