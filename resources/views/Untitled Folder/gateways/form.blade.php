	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			{!! Form::textarea('comment', null, ['class' => 'form-control', 'rows'=>'2', 'autocomplete' => 'off', $readonly]) !!}
		</div>
	</div>
...
{{-- 	<div class="form-group">
	...
	<div class="form-group">
		{!! Form::label('config', null, ['class' => 'control-label col-xs-2']) !!}
		<div class="col-sm-10">
			{!! Form::textarea('config', null, ['class' => 'form-control', 'rows'=>'20', 'autocomplete' => 'off', $readonly]) !!}
		</div>
	</div>
